...
export const gorilla: Grammar = {
  ...
  parts: [
     ...
     *
     * **`marking: true`, and it took him telling me twice.** The first fix stopped the inner
     * outline ringing the saddle, which was real and was not the defect he was pointing at.
     * The defect was that these lobed masses stood **three pixels proud of the chest and hips
     * they lie on**, and where the two failed to meet, the gap between them was empty canvas
     * with the outer outline traced around it — a notch cut into the back at the waist.
     *
     * A marking recolours a surface. It paints only where a solid already is, so it can add
     * nothing to a silhouette and cannot cut anything out of one.
     */
    { name: 'saddleB', bone: 'chest', material: 'silver', z: -1, marking: true, shape: { kind: 'lobed', cx: -2.6, cy: -5.2, rx: 9.4, ry: 6.2, rz: 9.5, lobes: 5, depth: 0.17, phase: 0.7, octaves: 2 } },
    { name: 'saddleH', bone: 'hips', material: 'silver', z: -1, marking: true, shape: { kind: 'lobed', cx: -0.6, cy: -4.6, rx: 7.8, ry: 4.8, rz: 8, lobes: 4, depth: 0.2, phase: 2.4, octaves: 2 } },
