...
const JUMP: Gait = {
  ...
  tracks: [
    ...
    { bone: 'legNL', channel: 'angle', keys: [0, -0.57, 0.15, -0.51, -0.63, -0.7] },
    ...
    { bone: 'legFL', channel: 'angle', keys: [-0.04, -0.5, 0.18, -0.44, -0.56, -0.63] },
    ...
    { bone: 'armNL', channel: 'angle', keys: [0, 0.28, -0.2, 0.14, 0.38, 0.24] },
...
const ATTACK: Gait = {
  ...
  tracks: [
    ...
    { bone: 'armNL', channel: 'angle', keys: [0, 0.35, -0.15, -0.2, 0.05] },
    ...
    { bone: 'armFL', channel: 'angle', keys: [0, 0.3, -0.1, -0.18, 0.04] },
    ...
    { bone: 'legNL', channel: 'angle', keys: [0, -0.1, 0.05, -0.15, -0.025] },
    ...
    { bone: 'legFL', channel: 'angle', keys: [-0.05, -0.14, 0.01, -0.17, -0.06] },
  ],
}
